...
var postgresql = builder.AddPostgres("postgresql").WithPgAdmin().WithLifetime(ContainerLifetime.Persistent);

var posgresqldb = postgresql.AddDatabase("postgresqldb");

var cache = builder.AddRedis("cache").WithClearCommand().WithLifetime(ContainerLifetime.Persistent);
